...
### Tout d'abord, bravo pour les commentaires complets et détaillés que tu laisses dans tes scripts

### Ensuite, quel excellent sujet! Ton ancrage dans l'actualité est parfait.
...
### Seul détail:
### L'indentation de ta boucle est parfois faite avec des espaces, parfois avec des tabs
### Non seulement python n'aime pas: «TabError: inconsistent use of tabs and spaces in indentation»
### Mais cela faisait en sorte que certaines commandes étaient mal indentées et ne fonctionnaient pas
...
### Ici, j'ajouterais à ta liste «semiautomatique» l'URL de la page où elle se trouve
### C'est toujours pratique et cela permet de faire des vérifications pour voir si on a les bonnes données
...
### WOW! Je ne connaissais pas cette technique! :)
